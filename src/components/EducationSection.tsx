...
export const EducationSection: React.FC = () => {
  return (
    <section id="academics" className="py-16 border-b border-[#1a233a] overflow-hidden">
          ...
          {EDUCATION_LIST.map((edu, index) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-lg bg-[#131b2e] border border-[#222a3d] p-5 sm:p-6 hover:border-[#6366f1]/40 hover:-translate-y-1 hover:shadow-[0_12px_30px_rgba(0,0,0,0.35)] transition-all duration-300 flex flex-col md:flex-row md:items-center justify-between gap-6 group"
              >
                {/* Left details */}
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 rounded-md bg-[#171f33] border border-[#2d3449] group-hover:border-[#6366f1]/50 group-hover:scale-105 flex items-center justify-center shrink-0 mt-0.5 transition-all duration-300">
                    {icons[index]}
                  </div>
                  <div>
                    {/* Badges */}
                    <div className="flex flex-wrap items-center gap-2 mb-1.5">
                      <span className="px-2 py-0.5 text-[11px] font-mono rounded-sm bg-[#171f33] border border-[#2d3449] text-[#4edea3] group-hover:border-[#4edea3]/40 transition-colors">
                        {edu.badge}
                      </span>
                ...
                <div className="md:border-l md:border-[#222a3d] md:pl-8 flex flex-row md:flex-col items-baseline md:items-end justify-between md:justify-center shrink-0">
                  ...
                  <div className="text-2xl sm:text-3xl font-mono font-bold text-[#4edea3] my-0.5 group-hover:scale-105 transition-transform duration-300">
                    {edu.metricValue}
                  </div>
